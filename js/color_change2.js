...
// instantitate the initArray
var col=new initArray();

//dom.style.background = accessing the DOM css background prperty
function stop() {
...
function change_color() {
    ...
    index++;
    // if the index in the array is less 0 or greater 13 than
    ...
    // syntax varies for the browers being used
